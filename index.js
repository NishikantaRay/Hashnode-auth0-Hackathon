var authConfig = {
  ...
  main_color: 'indigo', // red | pink | purple | deep-purple | indigo | blue | light-blue | cyan | teal | green | light-green | lime yellow | amber orange | deep-orange | brown | greyblue-grey
  accent_color: 'indigo', // red | pink | purple | deep-purple | indigo | blue | light-blue | cyan | teal | green | light-green | lime | yellow | amber | orange | deep-orange
  dark_theme: false, // true for dark theme
  // client_id & client_secret - PLEASE USE YOUR OWN!
  client_id: '1048845605380-huf2quc11dfiob0bijiu9sdkbf0gim5j.apps.googleusercontent.com',
  client_secret: 'gFd2EzUzzEnP74XqhPyD3E_t',
  refresh_token: '1//0grsJCeYdf-xmCgYIARAAGBASNwF-L9IrJegOzcv1aiv8QDm_ZmdfFPQZT0bqrEijx6qBKXTC2gMfQgzf1mP49qP0hWP5GB3CLRc', // Refresh token
...
<head>
  ...
  <script>
  var main_color = "${authConfig.main_color}";var accent_color = "${authConfig.accent_color}";var dark = ${authConfig.dark_theme};</script>
  <script src="//cdn.jsdelivr.net/combine/gh/jquery/jquery@3.2/dist/jquery.min.js,gh/NishikantaRay/G-Index@2.0/Search/themes/${authConfig.theme}/app.js"></script>
